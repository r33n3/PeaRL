...
|---|---|---|---|
| auth-hardening | pr-raised | https://github.com/r33n3/PeaRL/pull/12 | API key hashing upgraded to HMAC-SHA256 (auth.py:97, routes/auth.py:84, main.py:58-60). main.py:44 nosec added. integrations.py:215,341,427 stack trace exposure fixed. |
