...
class RemediationSpecRow(Base, TimestampMixin):
    __tablename__ = "remediation_specs"

    remediation_spec_id: Mapped[str] = mapped_column(String(128), primary_key=True)
